    ...
    <AdminDrawer onLogout={handleLogout}>
      <ScrollView style={styles.container}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.infoGrid}>
            <View style={styles.infoItem}>
              <Icon name="receipt" size={20} color={THEME.textMuted} />
            ...
            <View style={styles.infoItem}>
              <Icon name="event" size={20} color={THEME.textMuted} />
              <View style={styles.infoContent}>
            ...
            <View style={styles.infoItem}>
              <Icon name="payment" size={20} color={THEME.textMuted} />
              <View style={styles.infoContent}>
            ...
            {order.paymentInfo?.status && (
              <View style={styles.infoItem}>
                <Icon name="check-circle" size={20} color={THEME.textMuted} />
                <View style={styles.infoContent}>
                  <Text style={styles.infoLabel}>Payment Status</Text>
                  <Text style={[
                    styles.infoValue,
                    { color: order.paymentInfo.status === 'paid' ? THEME.success : THEME.warning }
                  ]}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.infoGrid}>
            <View style={styles.infoItem}>
              <Icon name="person" size={20} color={THEME.textMuted} />
              <View style={styles.infoContent}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.addressContainer}>
            <Icon name="location-on" size={20} color={THEME.textMuted} />
