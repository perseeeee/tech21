...
const ORDER_STATUSES = [
  { label: 'Processing', value: 'Processing', color: THEME.accent },
  { label: 'Accepted', value: 'Accepted', color: '#22C55E' },
  { label: 'Out for Delivery', value: 'Out for Delivery', color: THEME.warning },
  { label: 'Delivered', value: 'Delivered', color: THEME.success },
  { label: 'Cancelled', value: 'Cancelled', color: THEME.danger },
];
