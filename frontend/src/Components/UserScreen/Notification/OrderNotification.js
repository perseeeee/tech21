...
export default function OrderNotification() {
  ...
  const registerForPushNotificationsAsync = async () => {
    ...
    try {
      if (isExpoGo) {
        const message = 'Remote push registration is not supported in Expo Go. Use a development build for push token features.';
        setDebugInfo(`⚠️ ${message}`);
        Alert.alert('Expo Go Limitation', message);
        return;
      }
        ...
        <View style={styles.notificationContent}>
          ...
          {data?.orderId && (
            <View style={styles.orderIdContainer}>
              <Icon name="shopping-bag" size={12} color="#475569" />
      ...
      {__DEV__ && (
        <ScrollView style={styles.debugContainer}>
          ...
          <View style={styles.debugRow}>
            ...
            <Text style={[styles.debugValue, { color: tokenStatus.includes('✅') ? '#4CAF50' : '#DC2626' }]}>
              {tokenStatus}
            </Text>
          </View>
          ...
          <View style={styles.debugButtonRow}>
            ...
            >
              ...
              <Text style={[styles.debugButtonText, { color: '#0EA5E9' }]}>Check Status</Text>
            </TouchableOpacity>
          </View>
          ...
          <View style={styles.debugButtonRow}>
            ...
            >
              ...
              <Text style={[styles.debugButtonText, { color: '#DC2626' }]}>Remove Token</Text>
            </TouchableOpacity>
            ...
            >
              <Icon name="api" size={18} color="#0EA5E9" />
              <Text style={[styles.debugButtonText, { color: '#0EA5E9' }]}>Test Backend</Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
      )}
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        {notifications.length > 0 && (
          ...
          >
            <Icon name="delete-sweep" size={24} color="#DC2626" />
          </TouchableOpacity>
        )}
      </View>
