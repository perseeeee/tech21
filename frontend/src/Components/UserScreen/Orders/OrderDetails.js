          ...
          >
            ...
            <View style={styles.header}>
              ...
              <View style={styles.statusBadge}>
                <View style={[styles.statusDot, { backgroundColor: STATUS_COLORS[order.orderStatus] || '#64748B' }]} />
                <Text style={[styles.statusText, { color: STATUS_COLORS[order.orderStatus] || '#64748B' }]}>
                  {order.orderStatus}
                </Text>
              </View>
            </View>
            ...
            {order.orderStatus === 'Cancelled' && (
              <View style={styles.cancelledContainer}>
                <Icon name="cancel" size={24} color="#0EA5E9" />
            ...
            <View style={styles.section}>
              ...
              <View style={styles.infoRow}>
                <Icon name="phone" size={18} color="#475569" />
            ...
            <View style={styles.section}>
              ...
              <View style={styles.infoRow}>
                <Icon name="payment" size={18} color="#475569" />
                <Text style={styles.infoText}>
              ...
              <View style={styles.infoRow}>
                <Icon name="receipt" size={18} color="#475569" />
                <Text style={styles.infoText}>
            ...
            <View style={styles.section}>
              ...
              {order.deliveredAt && (
                <View style={styles.dateRow}>
                  <Icon name="check-circle" size={16} color="#64748B" />
