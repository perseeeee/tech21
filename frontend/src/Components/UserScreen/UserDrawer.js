        ...
        },
        {
          ...
          onPress: async () => {
            try {
              ...
              // AppNavigator listens to auth changes and switches to auth stack.
              // Fallback navigation for edge cases where immediate rerender is delayed.
