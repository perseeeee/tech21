      ...
      <View style={styles.orderItemDetails}>
        ...
        <View style={styles.quantityRow}>
          ...
          <TouchableOpacity
            ...
            disabled={disabled}
          >
            <Icon name="remove" size={18} color="#0EA5E9" />
          </TouchableOpacity>
          ...
          <TouchableOpacity
            ...
            disabled={disabled}
          >
            <Icon name="add" size={18} color="#0EA5E9" />
          </TouchableOpacity>
        </View>
      </View>
          ...
          >
            ...
            <View style={styles.section}>
              ...
              <View style={styles.infoBox}>
                ...
                <View style={styles.infoRow}>
                  <Icon name="map" size={20} color="#0EA5E9" />
                ...
                <View style={styles.infoRow}>
                  <Icon name="location-city" size={20} color="#0EA5E9" />
                ...
                <View style={styles.infoRow}>
                  <Icon name="markunread-mailbox" size={20} color="#0EA5E9" />
