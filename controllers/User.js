...
exports.registerUser = async (req, res) => {
  try {
    ...
    if (requireEmailVerification) {
      ...
      console.log('ℹ️ Development mode: skipping email verification flow');
    }

    res.status(201).json({
      success: true,
      message: requireEmailVerification
        ? `Registration successful! Verification email sent to ${user.email}. Please verify your email before logging in.`
